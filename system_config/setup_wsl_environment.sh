...
# ROS 2 JAZZY Edition (for Ubuntu 24.04 Noble)
# ==============================================================================
...
# 2. Check/Install ROS 2 Jazzy (for Ubuntu 24.04)
echo ""
echo "Step 2: Checking ROS 2 Jazzy installation..."

if [ -f "/opt/ros/jazzy/setup.bash" ]; then
    print_status "ROS 2 Jazzy is already installed"
    source /opt/ros/jazzy/setup.bash
    ros2 --version
else
    print_warning "ROS 2 Jazzy not found. Installing..."
    ...
    print_status "ROS 2 Jazzy installed successfully"
fi
...
if ! grep -q "source /opt/ros/jazzy/setup.bash" "$ENV_FILE"; then
    echo "" >> "$ENV_FILE"
    echo "# ROS 2 Jazzy" >> "$ENV_FILE"
    echo "source /opt/ros/jazzy/setup.bash" >> "$ENV_FILE"
    print_status "Added ROS 2 Jazzy to .bashrc"
else
    print_status "ROS 2 Jazzy already in .bashrc"
fi
